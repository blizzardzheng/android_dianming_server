...
import com.web.info.InfoMgrDao;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (method.equals("list")) {
		    ...
		    if (type != null && type.equals("json")) {
		    	...
		    	if(  req.getParameter("tuisong") != null && req.getParameter("tuisong").equals("yes") ){
		    		  jsonArray = JSONArray.fromObject( newsMgrDao.getAllFor_tuisong()  );
		    	}else{
		    		   jsonArray  =  JSONArray.fromObject( newsMgrDao.getAll(req.getParameter("name")) );
		    	} 
			...
			newsMgrDao.updateTuisong( req.getParameter("id") ,  req.getParameter("tuisong")   );
			getAll(req, newsMgrDao);
			req.getRequestDispatcher("/type_list.jsp").forward(req, resp);

		} else if (   method.equals("go_add") ){

			req.setAttribute( "infoList" , infoMgrDao.getAll(null));
