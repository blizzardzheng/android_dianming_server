...
public class Resources extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String search_name = null , search_type = null ;
		...
		if( request.getParameter("search_type" ) != null && !"".equals( request.getParameter("search_type" ) )){
			search_type =  request.getParameter("search_type" )  ;
		}
		
		response.getWriter().write(DBControl.getAllResources( search_name , search_type  , order ).toString() );
	}
