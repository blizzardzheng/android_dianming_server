...
<body>
	...
	<form name="form1" action="infoEdit.do?method=save" method="post"  >
		<div class="loglist">
				<table width="90%" cellspacing="0" cellpadding="0" align="center">
					...
					<tr align="left">
						...
						<td width="70%">
							...
							<input type="text" name="name" value="${map.name}"  size="50" >
						</td>
					</tr>
					...
					<tr>
						...
						<td  width="70%">
							<input name="description" type="text" size="50"  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  >
						</td>
					</tr>	
