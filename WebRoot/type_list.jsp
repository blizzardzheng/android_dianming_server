          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 信息管理 </span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"> 推送状态 </span></div></td>
			...
			<c:forEach var="item" items="${list}" varStatus="idx"  >  
		      <tr>
				...
				<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
							...
							<c:choose>
								<c:when test="${(not empty item.tuisong ) && (item.tuisong == 'no' )}">
						    		<label>未推送</label>
								</c:when>
								<c:when test="${(not empty item.tuisong) && (item.tuisong == 'yes' )}">
						    		<label>已推送</label>
								</c:when>
							</c:choose>
		        ...
		        <a href="type.do?method=update&tuisong=yes&id=${item.id}"> 推送</a>  
		        <a href="type.do?method=update&tuisong=no&id=${item.id}"> 不推送</a>  
